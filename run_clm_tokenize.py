...
def main():
    ...
    logger.warning("This script is used only for data preprocessing and does not do any training nor evaluation")
    logger.warning(
    ...
    logger.info(f"fingerprint of tokenized dataset: {tokenized_datasets.keys()}")
